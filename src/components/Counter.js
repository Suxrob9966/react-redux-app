...
import { useDispatch, useSelector, connect } from 'react-redux'; // we need useSelector() hook to read data from our redux store. we need connect to use redux in class based components
